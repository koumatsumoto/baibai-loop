...
def test_cli_recomputes_action_from_draft(capsys: pytest.CaptureFixture[str]) -> None:
    exit_code = main(["holding-review", "--input", str(FIXTURES / "replacement-superior.yaml")])
    assert exit_code == 0
