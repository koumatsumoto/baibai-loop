...
def _hash(
    *,
    ...
    expected_return_model_id: str = "expected-return-v1",
    ...
    return value_carry_selection_policy_hash(
        ...
        candidate_diagnostic_parameters=CandidateDiagnosticRules().model_dump(mode="json"),
...
def test_value_carry_policy_hash_changes_with_membership_or_order_inputs() -> None:
    ...
    assert _hash(expected_return_model_id="expected-return-v2") != baseline
