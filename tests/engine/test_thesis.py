...
def test_golden_thesis_is_ready_with_explicit_evidence_warning() -> None:
    ...
    assert (
        result.thesis_sha256 == "99a42521538122c534f6f2cc7893da88a2fc9888b79d4e74d31f2447280e8f7b"
    )
...
def test_thesis_rejects_unknown_judgment_field() -> None:
    raw = _raw()
    judgment = raw["judgment"]
    assert isinstance(judgment, dict)
    judgment["unexpected_field"] = "unexpected"
