...
4 成分アーキテクチャ v1 の **(a) マクロ事実ブリーフ** を蓄積するディレクトリ。世界情勢・日本経済・業種動向の一次情報を、短い事実 + 要点として時系列で記録する。

- **独立トラック**: 売買ループ（screened → research → trade → review）から独立して積み上がる
- **アーキテクチャ上の位置付け**: `brief` を source とし、[`view/`](../docs/components/view.md) がマクロ見解を構築する
...
brief/2026/04/2026-04-macro-monthly-us-cpi-hot.md
brief/2026/04/2026-04-30-fomc-hold.md
```
