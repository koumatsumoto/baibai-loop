...
- SQLite を作り直す場合は `bootstrap-cache --asof` と `extract-edinet-metrics --asof` で provider から必要 window を再取得します（[`../../docs/reference/screening-runtime.md`](../../docs/reference/screening-runtime.md)）
