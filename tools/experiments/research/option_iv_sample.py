...
window extended, and prints the quantiles the reading rules quote.
    ...
    uv run python tools/research/option_iv_sample.py --start 2018-01-01 \
        --end 2026-07-31 --step 4 \
        --out reports/studies/2026-07-31-option-iv-quantiles/artifacts/option-iv-sample.csv
"""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.out.suffix != ".csv":
        ...
        # whatever is there — stores/macro/macro.sqlite is one tab-completion away.
