...
from baibai_batch.storage.sqlite_snapshot import validate_database
from baibai_engine.batch_api import MARKET_DB_PATH

ROOT = Path(__file__).resolve().parents[4]
DEFAULT_MARKET_STORE = ROOT / MARKET_DB_PATH
