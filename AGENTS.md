...
subsystem、public CLI、schema、persistence、dependency、state、運用手順などの複雑性を増やす前に、期待効果の大きさと導入・保守・撤回コストを比較する。期待効果はbusiness value、利用頻度、意思決定改善、risk低減、evidence強度で評価し、作れることや実装済みであること自体を採用理由にしない。
