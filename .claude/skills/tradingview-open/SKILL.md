...
> **操作専用 skill**: docs 側に対応する仕様正本はなく、URL 組み立てと既定ブラウザ起動の〈操作〉だけを持つ。銘柄提示時に必ずリンクを添える運用ルールは [`operations/decision-cycle.md#proposal-first-layer`](../../../docs/operations/decision-cycle.md#proposal-first-layer) に従う。
