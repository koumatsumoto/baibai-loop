...
| `records/05-thesis/` の作成・変更 | [`operations/thesis-runbook.md`](./operations/thesis-runbook.md), [`components/thesis.md`](./components/thesis.md), [`components/playbooks.md`](./components/playbooks.md) |
| `records/06-position/` の作成・変更 | [`components/position.md`](./components/position.md), [`operations/position-runbook.md`](./operations/position-runbook.md) |
