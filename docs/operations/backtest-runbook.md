...
| 2026-06-19 | strategy 改善 5 Phase (selection_ablation regime bug fix / lane order 並び替え / sector cap 緩和 / per_forward gate / sector 除外拡張 / deterioration & margin & FCF gate / accruals & net share issuance signal / back-fill cohort 分離 / dead variant 整理) | ablation full 4w mean rel **-10.98pt → -1.89pt (+9.09pt)** (PR #249 後 main vs Phase 3 後)、benchmark 規律下 cohort **rel +1.23pt** (全 trade -1.29pt から back-fill 3 件除外で +2.52pt 解像度向上) | 計測ベースに採用施策のみ統合、forward 計測経路を維持。残り B3 / E1 / C3 / D1 / D4-D6 / E2 / E4 / E6 は scope creep 回避で次回 PR (reports/2026-06-19-strategy-improvement-progress.md §4 参照) |
