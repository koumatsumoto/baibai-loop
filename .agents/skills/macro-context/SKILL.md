...
0. cloud 正本の store を読む前に pull する: `tools/cloud/r2_transfer.sh pull-machine`（market / runs / macro。規律は ops-maintenance skill）。application DB は local が正本なので pull しない。
