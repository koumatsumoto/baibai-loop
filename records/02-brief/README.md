...
- **アーキテクチャ上の位置付け**: `brief` を source とし、[`records/03-outlook/`](/docs/components/outlook.md) がマクロ見解を構築する
...
```
records/02-brief/2026/04/2026-04-19-world-weekly-us-iran-deescalation.yaml
records/02-brief/2026/04/2026-04-macro-monthly-us-cpi-hot.yaml
records/02-brief/2026/04/2026-04-30-fomc-hold.yaml
```
...
詳細: [`docs/components/brief.md`](/docs/components/brief.md) と [`records/_schemas/brief.json`](/records/_schemas/brief.json)
...
INDEX ファイルは設けない。一覧は `git ls-files records/02-brief/` または GitHub ツリーで確認する。
