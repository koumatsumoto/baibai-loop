...
6310 井関農機は、2026-05-01 candidates で `cashflow-yield-discount` と `sales-discount-growth` が同時 hit した。OCF yield 59.1%、P/S 0.21、PBR 0.53、売上 YoY +10.3% で、今回の「お買い得を拾う」目的に最も合う上位候補の一つ。ただし 2026-05-15 に 1Q 決算発表予定があり、2026-05-05 時点で新規注文は決算またぎ kill switch に近い。decision は pending とし、1Q 通過後に thesis が崩れなければ 100 株を採用する。
...
- 機械 sector gate が headwind に悪化する。

## Position size

- **decision**: pending
- **primary signal**: cashflow-yield-discount
- **supporting signal**: sales-discount-growth
- **market cap**: 397 億円
- **avg turnover**: 2.0 億円
- **paper proxy position**: 0.01 億円
- **ADV participation**: 0.5%
- **実資金想定**: 1Q 通過後 100 株、5/1 終値基準 172,600 円
- **許容上限**: 複数 signal だが net debt と決算直前のため初期 1%
