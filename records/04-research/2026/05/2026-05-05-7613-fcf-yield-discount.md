...
ただし decision は pending。2025/12 期は売上 YoY -4.2%、親会社株主帰属当期純利益 -33.7%、EDINET net cash ratio は -22.7% で net debt。FCF は強いが、運転資本改善や投資抑制による一過性の可能性を確認するまで accepted にしない。
...
- **業種**: 卸売業
- **outlook_ref**: records/02-outlook/2026/05/outlook-2026-05-04-post-fomc-boj-hold.yaml
- **根拠**: 2026-05-04 outlook は卸売業を neutral としている。総合商社は資源と非資源の mix があり、中堅卸売業も製品 mix が多様なため、sector 一括 tailwind とはしない。
- **保守側判定**: neutral。FCF の個別強度を見に行くが、macro tailwind で押し上げる銘柄ではない。
...
| FCF yield | 35.8% | signal hit |
| J-Quants OCF yield | 41.0% | supporting signal |
| CFO YoY | +14.9% | 悪化なし |
| PBR | 0.59 | 資産面の補助 |
| EV/EBITDA | 4.4 | 補助 |
...
配当利回りは候補化の primary signal ではないが、FCF thesis の裏付けとして重要。2025/12 期の配当性向は高く、純利益減少下での増配に見えるため、2026/12 期の EPS 回復見通しと減配リスクを確認する。
...
初期 paper proxy は 1.0% まで。signal は FCF + OCF の 2 本だが、net debt と売上減少があるため、multiple signal の最大枠をそのまま使わない。
...
ただし、FCF は運転資本で一時的に膨らむため、screening hit は entry ではない。accepted には一次資料で working capital quality と capex normalization を確認する必要がある。
