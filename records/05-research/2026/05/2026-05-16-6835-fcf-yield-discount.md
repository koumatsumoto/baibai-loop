...
- 注意: 電気機器 not_matched は AI / 半導体関連の色が強い。6835 はネットワーク機器で直接度は低く、macro context fit は not_matched とする。
...
research_decision は deferred。paper proxy、real order intent、ADV participation はすべて 0。Q2 CF 後の follow-up issue #166 で再確認する。
