...
- EDINET source trace: `edinet_source_doc_id`、`edinet_document_type`、`edinet_source_submit_datetime`、`edinet_source_period_start`、`edinet_source_period_end` を確認し、対象期間が FCF thesis と一致するか確認する。
