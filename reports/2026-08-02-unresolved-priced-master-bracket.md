...
事前登録は [`2026-08-02-unresolved-priced-master-bracket-preregistration.md`](./2026-08-02-unresolved-priced-master-bracket-preregistration.md) で固定した。特定axisの結果を見て規則、cohort、metric、control、採否条件を変更していない。
