...
calibration store は `data/screening/calibration-universe-er-population` に `--force` 再構築した。評価範囲は design = 2022-09-01..2024-06-30、confirm = 2024-07-01..2026-06-30。selection の top10 は `recommended_rank` / `selection_rank` / `er_population` が同一になり、採用基準 1-3 を満たす。
