...
規則・対象 metric・向き・採否条件は、計測前の commit `ef1bd2d` と [`2026-08-01-calibration-evidence-capacity-preregistration.md`](.../2026-08-01-calibration-evidence-capacity/preregistration/report.md) §1 で固定した。
