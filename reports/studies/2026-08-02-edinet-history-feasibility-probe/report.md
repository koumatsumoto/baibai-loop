...
- population source: `stores/screening/calibration/panel-2021-05-31.csv`の`in_population=true`
...
- external cache / SQLite: `/tmp`の隔離領域。canonical `stores/market/market.sqlite`は変更しない
