...
を持ち、[`SelectionLiquidityRules.matches`](../../../engine/src/baibai_engine/screening/rule_config.py) が
`market_cap_oku < 100` を不通過にする。selection と比較母集団は同じ liquidity predicate を使う。
[`liquid_median_population`](../../../engine/src/baibai_engine/screening/universe.py) はこの母集団を sector / market
