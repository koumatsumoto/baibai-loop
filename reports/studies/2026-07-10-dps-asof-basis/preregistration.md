...
```bash
uv run baibai-loop-screening calibration-build --start 2022-09-01 --end 2026-03-31 --calibration-dir stores/screening/calibration/variants/dps-asof-baseline --force
uv run baibai-loop-screening calibration-evaluate --calibration-dir stores/screening/calibration/variants/dps-asof-baseline --horizon 6m --start 2022-09-01 --end 2024-06-30 --out .cache/dps-asof-baseline-design-6m.yaml
uv run baibai-loop-screening calibration-evaluate --calibration-dir stores/screening/calibration/variants/dps-asof-baseline --horizon 6m --start 2024-07-01 --end 2026-03-31 --out .cache/dps-asof-baseline-confirm-6m.yaml
uv run baibai-loop-screening calibration-evaluate --calibration-dir stores/screening/calibration/variants/dps-asof-baseline --horizon 12m --start 2022-09-01 --end 2024-06-30 --out .cache/dps-asof-baseline-design-12m.yaml
uv run baibai-loop-screening calibration-evaluate --calibration-dir stores/screening/calibration/variants/dps-asof-baseline --horizon 12m --start 2024-07-01 --end 2026-03-31 --out .cache/dps-asof-baseline-confirm-12m.yaml

uv run baibai-loop-screening calibration-build --start 2022-09-01 --end 2026-03-31 --calibration-dir stores/screening/calibration/variants/dps-asof-confirmed --force
uv run baibai-loop-screening calibration-evaluate --calibration-dir stores/screening/calibration/variants/dps-asof-confirmed --horizon 6m --start 2022-09-01 --end 2024-06-30 --out .cache/dps-asof-confirmed-design-6m.yaml
uv run baibai-loop-screening calibration-evaluate --calibration-dir stores/screening/calibration/variants/dps-asof-confirmed --horizon 6m --start 2024-07-01 --end 2026-03-31 --out .cache/dps-asof-confirmed-confirm-6m.yaml
uv run baibai-loop-screening calibration-evaluate --calibration-dir stores/screening/calibration/variants/dps-asof-confirmed --horizon 12m --start 2022-09-01 --end 2024-06-30 --out .cache/dps-asof-confirmed-design-12m.yaml
uv run baibai-loop-screening calibration-evaluate --calibration-dir stores/screening/calibration/variants/dps-asof-confirmed --horizon 12m --start 2024-07-01 --end 2026-03-31 --out .cache/dps-asof-confirmed-confirm-12m.yaml
```
...
```bash
UV_CACHE_DIR=/tmp/uv-cache uv run baibai-loop-screening calibration-build --start 2022-09-01 --end 2026-03-31 --calibration-dir stores/screening/calibration/variants/dps-asof-baseline --force
UV_CACHE_DIR=/tmp/uv-cache uv run baibai-loop-screening calibration-build --start 2022-09-01 --end 2026-03-31 --calibration-dir stores/screening/calibration/variants/dps-asof-confirmed --force
UV_CACHE_DIR=/tmp/uv-cache uv run baibai-loop-screening calibration-evaluate --calibration-dir stores/screening/calibration/variants/dps-asof-baseline --horizon 6m --start 2022-09-01 --end 2024-06-30 --out .cache/dps-asof-baseline-design-6m.yaml
UV_CACHE_DIR=/tmp/uv-cache uv run baibai-loop-screening calibration-evaluate --calibration-dir stores/screening/calibration/variants/dps-asof-baseline --horizon 6m --start 2024-07-01 --end 2026-03-31 --out .cache/dps-asof-baseline-confirm-6m.yaml
UV_CACHE_DIR=/tmp/uv-cache uv run baibai-loop-screening calibration-evaluate --calibration-dir stores/screening/calibration/variants/dps-asof-confirmed --horizon 6m --start 2022-09-01 --end 2024-06-30 --out .cache/dps-asof-confirmed-design-6m.yaml
UV_CACHE_DIR=/tmp/uv-cache uv run baibai-loop-screening calibration-evaluate --calibration-dir stores/screening/calibration/variants/dps-asof-confirmed --horizon 6m --start 2024-07-01 --end 2026-03-31 --out .cache/dps-asof-confirmed-confirm-6m.yaml
UV_CACHE_DIR=/tmp/uv-cache uv run baibai-loop-screening calibration-evaluate --calibration-dir stores/screening/calibration/variants/dps-asof-baseline --horizon 12m --start 2022-09-01 --end 2024-06-30 --out .cache/dps-asof-baseline-design-12m.yaml
UV_CACHE_DIR=/tmp/uv-cache uv run baibai-loop-screening calibration-evaluate --calibration-dir stores/screening/calibration/variants/dps-asof-baseline --horizon 12m --start 2024-07-01 --end 2026-03-31 --out .cache/dps-asof-baseline-confirm-12m.yaml
UV_CACHE_DIR=/tmp/uv-cache uv run baibai-loop-screening calibration-evaluate --calibration-dir stores/screening/calibration/variants/dps-asof-confirmed --horizon 12m --start 2022-09-01 --end 2024-06-30 --out .cache/dps-asof-confirmed-design-12m.yaml
UV_CACHE_DIR=/tmp/uv-cache uv run baibai-loop-screening calibration-evaluate --calibration-dir stores/screening/calibration/variants/dps-asof-confirmed --horizon 12m --start 2024-07-01 --end 2026-03-31 --out .cache/dps-asof-confirmed-confirm-12m.yaml
```
