...
事前登録はcommit `0e37eb3`、結果を読む前に固定したoptional metric authorityとsurvivorship判定はcommit `32e00ed` である。入力、方向、cohort、control、採否条件は [`2026-08-02-margin-short-production-preregistration.md`](.../2026-08-02-margin-short-production/preregistration/report.md) を正本とする。
...
親evidenceは [`2026-08-02-margin-supply-demand-adoption.md`](../2026-08-02-margin-supply-demand-adoption/report.md) の固定値を再利用した。1y design / confirmのmean decile spreadは+7.28pt / +15.48pt、positive cohort shareは94.74% / 94.44%、authority eligibleな3y designは+9.85pt / 100%だった。1y両窓と3y designの全controlもmedian正・trap非正である。
