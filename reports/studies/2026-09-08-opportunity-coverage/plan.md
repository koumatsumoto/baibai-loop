...
W2の独立ラベルと主の照合を2026-09-08T20:39:44.967199+09:00に固定した後、所属・原順位・Oを知らない独立contextが、同じ時点の保有/予約除外後の主標本Y 24社からC*を選んだ。新規資料取得前の固定時刻は2026-09-08T11:42:54.838172+00:00。

- C*: 4970、6675、4439、7279（oc-05/11/17/20）。失敗時補充なし。
- 重要な問いを一次資料で狭める経路を優先し、同程度なら事前hash順。選択・見送り24社の理由はprivate `cstar-selection.json/md`。
- O: 6419、4231、2415、2221。計8社を同cutoff（9月7日JST日末）、最新決算・補足・年報関連節・重要な株数/資産開示で深掘りする。原4社との重複6675は同範囲だけ再利用。
- 選定JSON SHA-256: `d0c1680e7af628a5d9296dd619066e69644559a6c9f3aa858c79d1a0a696ca22`。入力SHA-256: `e82409e0d5a0521207be8b3720c1f334bdbc8b2b5eb7bccb3add27d4a4dc829d`。
- 別の未開示contextが8社から合計最大4社を選び直す。Base年率だけで選ばず、企業評価・購入価格・未知を区別する。既存正式判断は変更しない。
