...
を持つ。[`SelectionLiquidityRules.matches`](../../../engine/src/baibai_engine/screening/rule_config.py) は、candidate の
...
変更は候補 filter だけではない。[`liquid_median_population`](../../../engine/src/baibai_engine/screening/universe.py)
