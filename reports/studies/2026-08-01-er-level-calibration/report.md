...
集計規則、field、required scope、候補係数の推定式、採否条件は commit `e4dfe7e` と [`2026-08-01-er-level-calibration-preregistration.md`](.../2026-08-01-er-level-calibration/preregistration/report.md) で結果計測前に固定した。
