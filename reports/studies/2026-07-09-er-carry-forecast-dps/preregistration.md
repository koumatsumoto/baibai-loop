...
```bash
uv run baibai-loop-screening calibration-build --start 2022-09-01 --end 2026-03-31 --calibration-dir stores/screening/calibration/variants/er-carry-baseline --force
uv run baibai-loop-screening calibration-evaluate --calibration-dir stores/screening/calibration/variants/er-carry-baseline --horizon 6m --start 2022-09-01 --end 2024-06-30 --out .cache/er-carry-baseline-design-6m.yaml
uv run baibai-loop-screening calibration-evaluate --calibration-dir stores/screening/calibration/variants/er-carry-baseline --horizon 6m --start 2024-07-01 --end 2026-03-31 --out .cache/er-carry-baseline-confirm-6m.yaml

uv run baibai-loop-screening calibration-build --start 2022-09-01 --end 2026-03-31 --calibration-dir stores/screening/calibration/variants/er-carry-forecast-dps --force
uv run baibai-loop-screening calibration-evaluate --calibration-dir stores/screening/calibration/variants/er-carry-forecast-dps --horizon 6m --start 2022-09-01 --end 2024-06-30 --out .cache/er-carry-forecast-dps-design-6m.yaml
uv run baibai-loop-screening calibration-evaluate --calibration-dir stores/screening/calibration/variants/er-carry-forecast-dps --horizon 6m --start 2024-07-01 --end 2026-03-31 --out .cache/er-carry-forecast-dps-confirm-6m.yaml
```
...
```bash
uv run pytest tests/engine/test_screening_metrics.py tests/engine/test_screening_estimates.py tests/engine/test_screening_selection_liquidity.py
